...
import sistema_organizacion.sistema.usecases.grupo.impl.ListarMiembrosDeGrupoInteractor;
...
import sistema_organizacion.sistema.usecases.tarea.impl.ActualizarEstadoTareaInteractor;
import sistema_organizacion.sistema.usecases.tarea.impl.CrearTareaInteractor;
import sistema_organizacion.sistema.usecases.tarea.impl.EliminarTareaInteractor;
import sistema_organizacion.sistema.usecases.tarea.impl.ListarTareasAsignadasInteractor;
...
public class BeanConfig {
    ...
    @Bean
    public ListarMiembrosDeGrupoUseCase listarMiembrosDeGrupoUseCase(
            GrupoFamiliarOutputPort grupoOutputPort,
            UsuarioOutputPort usuarioOutputPort) {
        return new ListarMiembrosDeGrupoInteractor(grupoOutputPort, usuarioOutputPort);
    }
    ...
    public CrearTareaUseCase crearTareaUseCase(
        ...
        return new CrearTareaInteractor(usuarioOutputPort, grupoOutputPort, tareaOutputPort);
    }
    ...
    public ModificarTareaUseCase modificarTareaUseCase(
            UsuarioOutputPort usuarioOutputPort,
            TareaOutputPort tareaOutputPort) {
        return new ModificarTareaInteractor(usuarioOutputPort, tareaOutputPort);
    }
    ...
    public EliminarTareaUseCase eliminarTareaUseCase(
            UsuarioOutputPort usuarioOutputPort,
            TareaOutputPort tareaOutputPort) {
        return new EliminarTareaInteractor(usuarioOutputPort, tareaOutputPort);
    }

    @Bean
    public ActualizarEstadoTareaUseCase actualizarEstadoTareaUseCase(
            UsuarioOutputPort usuarioOutputPort,
            TareaOutputPort tareaOutputPort) {
        return new ActualizarEstadoTareaInteractor(usuarioOutputPort, tareaOutputPort);
    }

    @Bean
    public ListarTareasAsignadasUseCase listarTareasAsignadasUseCase(
            UsuarioOutputPort usuarioOutputPort,
            TareaOutputPort tareaOutputPort) {
        return new ListarTareasAsignadasInteractor(usuarioOutputPort, tareaOutputPort);
    }
    ...
    public CrearDetalleTareaInteractor crearDetalleTareaInteractor(
            ...
            TareaOutputPort tareaOutputPort) {
        return new CrearDetalleTareaInteractor(detalleTareaOutputPort, tareaOutputPort);
    }
}
